...
class MoveAboveTaggedLocation(Sequence):
  def __init__(self, name='Move Above', location=None, dx=0, dy=0, dz=0.4, speed=0.3):
    super(MoveAboveTaggedLocation, self).__init__(children=[
      GetTaggedLocationPose(load_value=location, save_key='tag_pose'),
      ...
      TranslatePose(x=dx, y=dy, z=dz, load_key='tag_pose', save_key='tag_pose'),
