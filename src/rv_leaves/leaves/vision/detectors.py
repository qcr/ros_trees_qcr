...
class GetFaces(ServiceLeaf):
  def __init__(self, name=None, service_name='/service/face_tracking', *args, **kwargs):
    super(GetFaces, self).__init__(
      name=name if name else 'Get face pose',
...
class GetGraspPose(ServiceLeaf):
  def __init__(self, name=None, service_name='/service/ggcnn', *args, **kwargs):
    super(GetGraspPose, self).__init__(
      name=name if name else 'Get grasp pose',
      service_name=service_name,
      save_fn=lambda leaf, value: self._default_save_fn(value.result if hasattr(value, 'result') else None),
      *args, 
      **kwargs
...
class GetYoloDetections(ServiceLeaf):
  def __init__(self, name=None, service_name='/cloudvis/yolo', *args, **kwargs):
...
class GetValveDetections(ServiceLeaf):
  def __init__(self, name=None, service_name='/service/valves', *args, **kwargs):
...
class GetHandDetections(ServiceLeaf):
  def __init__(self, name=None, service_name='/service/hands', *args, **kwargs):
